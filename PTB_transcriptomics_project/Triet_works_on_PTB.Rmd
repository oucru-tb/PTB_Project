...
```{r}
Cell_names <- c("Neutrophil_counts","Monocyte_counts","Lymphocyte_counts",  "Eosinophil_counts")
...
# CellCounts combined
k = 0.996
png(file=paste0(path_output,"/Figure4A_CorrelationHeatmap_CNIH4vsICsvsCellCounts_TBM_combine1.png"),res=600, units = 'in',
    width = 12,
    height =12,)
grid.arrange(arrangeGrob(arrangeGrob(p1, p3,
                         widths = c(k,1-k)),
