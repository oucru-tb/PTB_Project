...
all.z <- abind(healthy.z[,common,],ptb.z[,common,],along = 1)
Neutrophil <- c('Neutro')
...
a = all.z_vst[intersect(rownames(all.z_vst),geneset),]
...
hm2 <- Heatmap(a[,sample_col][,31:326],
               name = 'expression',
        col=col_fun,
        cluster_rows = FALSE,
        cluster_columns = FALSE,
