...
###------BayesPrism------###
load(paste0(path_input,"Data/deconvolution_results/bp.res_ptb_SCnewman_01_01.RData"))
load(paste0(path_input,"Data/deconvolution_results/bp.res_healthy_SCnewman_01_01.RData"))
load(paste0(path_input,"Data/deconvolution_results/bp.res_tbm_SCnewman_01_01.RData"))
```
...
p <- ggplot(data=theta_long,
       aes(x = factor(group, level = c('Healthy','PTB','TBM (HIV-)','TBM (HIV+)')),
           ...
           y=value,))+
  facet_wrap(~factor(name, level=c('B','CD4T','CD8T','NK','Monocyte','Neutrophil')), ncol = 6)+
  geom_boxplot() +
