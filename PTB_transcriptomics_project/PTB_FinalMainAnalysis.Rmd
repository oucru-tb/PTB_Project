...
#### 3.5.0. Prepared data for visualization
...
```{r}
ptb_tcr <- as.data.frame(ptb.z[,,'Neutro']) %>% select(any_of(TCR_signaling))
ptb_tcr <-vst(round(t(ptb_tcr)),
              blind=T,
              nsub = 200,
              fitType='parametric')
ptb_tcr
