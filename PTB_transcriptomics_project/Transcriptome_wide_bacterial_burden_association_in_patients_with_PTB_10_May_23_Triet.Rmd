...
path_output<- "W:/#oucru-tb/PTB_Project/Triet_Results"
path_input <- "C:/Users/triettm/OneDrive - Oxford University Clinical Research Unit/#OUCRU-TB/#oucru-tb/PTB_project/"
###------Import clinical data------###
load("C:/Users/triettm/OneDrive - Oxford University Clinical Research Unit/#OUCRU-TB/#oucru-tb/PTB_project/Raw_data/vst_Gensymbol_allPTB_295Sample_18Feb22.RData")
...
```{r}
impute_df <- read.csv('C:/Users/triettm/OneDrive - Oxford University Clinical Research Unit/#OUCRU-TB/#oucru-tb/PTB_project/Raw_data/CIBERSORTx_Adjusted_CPM_LM22.txt',sep='\t') %>% filter(P.value<0.05)
...
library(patchwork)
library(egg)
impute_df <- read.csv('C:/Users/triettm/OneDrive - Oxford University Clinical Research Unit/#OUCRU-TB/#oucru-tb/PTB_project/Raw_data/CIBERSORTx_Adjusted_CPM_LM22.txt',sep='\t')
rownames(impute_df) <- impute_df$Mixture
impute_df$Mixture <- NULL
