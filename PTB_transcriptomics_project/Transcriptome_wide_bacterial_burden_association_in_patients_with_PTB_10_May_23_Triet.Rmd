...
png(file=paste0(path_output,"/Figure4A_correlation_CNIH4vsICs.png"),res=600, units = 'in', 
    width = 9.5, 
    height =9.5,
    )
...
# 
# library(cowplot)
# legend <- get_legend(as.ggplot(p1))   # get the legend of the first one plot
# 
# # here the plots in a grid
# prow <- plot_grid( as.ggplot(p1) + theme(legend.position="none"),
#            # here you add the percentage
#            as.ggplot(p2) + theme(legend.position="none")+
...
# 
# 
# grid.arrange(as.ggplot(p1), 
#              p3,
#              as.ggplot(p2), 
#              layout_matrix = matrix(c(1,3,2,3), 
#                                     nrow = 2))
# 
# gA <- ggplotGrob(as.ggplot(p1))
# gB <- ggplotGrob(as.ggplot(p2))
# grid::grid.newpage()
