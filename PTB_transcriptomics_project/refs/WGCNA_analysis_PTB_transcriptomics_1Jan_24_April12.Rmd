...
```{r include=FALSE}
l<-load(file="Data/network_construction_PTB.RData")
...
# Mediation analysis in PTB

We investigate the following associations:

1: Mtb burden--> IFN signaling pathway --> PD-L1 pathway

2: PD-L1 pathway--> CNIH4--> T-cell receptor signaling pathways

3: Mtb burden --> T-cell receptor signaling pathway --> lymphopenia

4: TB infection (healthy vs TB) --> IFN signaling pathway. 

May be the infection, or signal contributed mostly by neutrophils--> Perform the whole analysis baxsed on imputed data.

### Association between the factors above 
...
GSVA_targeted <- gsva(t(datExpr), gset.idx.list=targeted_pathways,method="ssgsea",mx.diff=T,BPPARAM=MulticoreParam(12))
...
p1<-ggplot(data=GSVA_targetedcombined,aes(x=log2_CT,y=IFN_gamma))+geom_point( size=2.5,alpha=0.5,col="#313695")+theme_bw()+stat_poly_line(se=T,col="#313695") +
  stat_cor(size = 4,cor.coef.name = "r")+scale_x_reverse()+theme(plot.title = element_text(size = 15),
        legend.position = "none",
        axis.text = element_text(size = 15),
        axis.text.x=element_text(color="black",size=13,face="bold"),
        axis.title.x = element_text(size = 15,color="black",face="bold"),
        ...
        legend.title = element_text( colour="black", size=12),
        legend.key = element_rect(colour = NA),
        strip.text=element_text(face = "bold",size=12))+ylab("Enrichment score of IFN gamma signaling pathways")+xlab("Mtb Xpert Ct value")
...
p2<-ggplot(data=GSVA_targetedcombined,aes(x=IFN_gamma,y=CD274))+geom_point( size=2.5,alpha=0.5,col="#313695")+theme_bw()+stat_poly_line(se=T,col="#313695") +
  stat_cor(size = 4,cor.coef.name = "r")+theme(plot.title = element_text(size = 15),
        legend.position = "none",
        axis.text = element_text(size = 15),
        axis.text.x=element_text(color="black",size=13,face="bold"),
        axis.title.x = element_text(size = 15,color="black",face="bold"),
        ...
        legend.title = element_text( colour="black", size=12),
        legend.key = element_rect(colour = NA),
        strip.text=element_text(face = "bold",size=12))+xlab("Enrichment score of IFN gamma signaling pathways")+ylab("Expression PD-L1")

p3<-ggplot(data=GSVA_targetedcombined,aes(x=CD274,y=TCR_signaling))+geom_point( size=2.5,alpha=0.5,col="#313695")+theme_bw()+stat_poly_line(se=T,col="#313695") +
  stat_cor(size = 4,cor.coef.name = "r")+theme(plot.title = element_text(size = 15),
        legend.position = "none",
        axis.text = element_text(size = 15),
        axis.text.x=element_text(color="black",size=13,face="bold"),
        ...
        legend.title = element_text( colour="black", size=12),
        legend.key = element_rect(colour = NA),
        strip.text=element_text(face = "bold",size=12))+ylab("Enrichment score of T-cell receptor signaling pathways")+xlab("Expression of PD-L1")
p4<-ggplot(data=GSVA_targetedcombined,aes(y=CNIH4,x=CD274))+geom_point( size=2.5,alpha=0.5,col="#313695")+theme_bw()+stat_poly_line(se=T,col="#313695") +
  stat_cor(size = 4,cor.coef.name = "r")+theme(plot.title = element_text(size = 15),
        legend.position = "none",
        axis.text = element_text(size = 15),
        axis.text.x=element_text(color="black",size=13,face="bold"),
        ...
        legend.title = element_text( colour="black", size=12),
        legend.key = element_rect(colour = NA),
        strip.text=element_text(face = "bold",size=12))+ylab("Expression of CNIH4")+xlab("Expression of PD-L1")
p5<-ggplot(data=GSVA_targetedcombined,aes(y=log2_Lymphocyte_counts,x=TCR_signaling))+geom_point( size=2.5,alpha=0.5,col="#313695")+theme_bw()+stat_poly_line(se=T,col="#313695") +
  stat_cor(size = 4,cor.coef.name = "r")+theme(plot.title = element_text(size = 15),
        legend.position = "none",
        axis.text = element_text(size = 15),
        axis.text.x=element_text(color="black",size=13,face="bold"),
        ...
        legend.title = element_text( colour="black", size=12),
        legend.key = element_rect(colour = NA),
        strip.text=element_text(face = "bold",size=12))+ylab("Lymphocyte [log2 counts]")+xlab("Enrichment score of T-cell receptor signaling pathways")

# png(file=paste0(path_output_2,"/Figure_3A_Asociation_between_important_factors.png"), wi = 16, he = 12,units = 'in', res = 480)
...
dat_test<-GSVA_targetedcombined %>% na.omit() 

# # model 1: regression_based method  for linear regresion model
# res_rb_param_bootstrap <- cmest(data = data, model = "rb", outcome = "Y", exposure = "A",
#                                 mediator = "M", basec = c("C1", "C2"), EMint = FALSE,
#                                 mreg = list("logistic"), yreg = "logistic",
#                                 astar = 0, a = 1, mval = list(1), 
#                                 estimation = "paramfunc", inference = "bootstrap", nboot = 2)
# 
# res_rb <- cmest(data = dat_test, model = "rb", outcome = "TCR_signaling", exposure = "CD274", mediator = "CNIH4",basec = c("Age"), EMint = FALSE,
#                    mreg = list("linear"), yreg = "linear", 
#                   astar = 0, a = 1, mval = list(1), 
#                   estimation = "paramfunc", inference = "bootstrap", nboot = 2000)
# summary(res_rb)$summarydf
# 
# # model 2: The Natural Effect Model for linear regresion model
# res_ne <- cmest(data = dat_test, model = "rb", outcome = "TCR_signaling", exposure = "CD274",
#                 mediator = "CNIH4", basec = c("Age"), EMint = FALSE,
#                 ereg = "linear",mreg = list("linear"),  yreg = "linear",
#                 astar = 0, a = 1, mval = list(1), 
#                 estimation = "imputation", inference = "bootstrap", nboot = 1000)
# summary(res_ne)$summarydf

# Model 3: The g-formula approach for linear regresion model
set.seed(1)
res_gformula <- cmest(data = dat_test, model = "gformula", outcome = "CD274",exposure = "log2_CT",
                      mediator = "IFN_gamma", basec =  c("Age"), EMint = FALSE,
...
mediated_res %<>%  mutate(Effect=case_when(Effect=="tnde"~"Natural direct impact",
                    ...
                    mutate(Effect=factor(Effect,levels=c("Natural direct impact","Natural indirect impact","Total impact","Proportion Mediated"))) 
  
save(res_gformula,mediated_res,file=paste0(path_output_1,"mediation_Mtb_IFN_gamma_signaling_PD_L1.Rdata"))
knitr::kable(mediated_res)
```


2: PD-L1 --> CNIH4--> T-cell receptor signaling pathways
...
# Model 3: The g-formula approach for linear regresion model
set.seed(1)
res_gformula <- cmest(data = dat_test, model = "gformula", outcome = "TCR_signaling",exposure = "CD274",
                      mediator = "CNIH4", basec =  c("Age"), EMint = FALSE,
                      mreg = list("linear"), yreg = "linear",multimp = TRUE,
                      astar = 0, a = 1, mval = list(1), 
                      estimation = "imputation", inference = "bootstrap", nboot = 3000)
...
save(res_gformula,mediated_res,file=paste0(path_output_1,"/mediation_PDl1_CNIH4_TCR.Rdata"))
knitr::kable(mediated_res)
```
...
3: PD-L1 --> T-cell receptor signaling pathway --> lymphopenia
...
# Model 3: The g-formula approach for linear regresion model
set.seed(1)
res_gformula <- cmest(data = dat_test, model = "gformula", outcome ="log2_Lymphocyte_counts",exposure = "CD274",
                      mediator = "TCR_signaling", basec =  c("Age"), EMint = FALSE,
                      mreg = list("linear"), yreg = "linear",multimp = TRUE,
                      astar = 0, a = 1, mval = list(1), 
                      estimation = "imputation", inference = "bootstrap", nboot = 3000)
...
save(res_gformula,mediated_res,file=paste0(path_output_1,"mediation_PDl1_TCR_lymphopenia.Rdata"))
knitr::kable(mediated_res)
```
...
### Association between the IFN gamma and bacterial load

```{r}
load(file="Raw_data/gene_clini_adjusted_ComBat_all.Rdata")
load(file="Raw_data/clinical_data_HC_PTB_TBM.RData")
load(file="Raw_data/Data_26_27_CT_CNIH4.Rdata.RData")

dat<-gene_clini_all %>% filter(Study%in%c("43TB","28TB","29TB"))

GSVA_targeted <- gsva(t(dat[,-c(1:5)]),gset.idx.list=targeted_pathways,method="ssgsea",mx.diff=T,BPPARAM=MulticoreParam(12))
GSVA_targeted<-as.data.frame(t(GSVA_targeted))

GSVA_targetedcombined<-merge(dat,GSVA_targeted,by='row.names')
GSVA_targetedcombined<-merge(subset(clinical_RNA,select=c("LIMS_ID","log2_CT")),GSVA_targetedcombined,by='LIMS_ID',all.y=T)

GSVA_targetedcombined %<>% dplyr::select(Row.names,"Study","log2_CT","CNIH4","IFNG","CD274",colnames(GSVA_targeted))
GSVA_targetedcombined %<>% mutate(log2_CT=ifelse(Study=="43TB", log2(51),log2_CT)) 
# p1<-ggplot(data=subset(GSVA_targetedcombined,log2_CT<log2(50)),aes(x=log2_CT,y=IFN_gamma))+geom_point( size=2.5,alpha=0.5,col="#313695")+theme_bw()+stat_poly_line(se=T,col="#313695") +
#   stat_cor(size = 4,cor.coef.name = "r",label.x=-5)+
#   stat_boxplot(data=subset(GSVA_targetedcombined,log2_CT>log2(50)),aes(x=log2(50),y=IFN_gamma), color="#08519c",geom = "errorbar",size=0.5)+
#   geom_boxplot(data=subset(GSVA_targetedcombined,log2_CT>log2(50)),aes(x=log2(50),y=IFN_gamma), color="#08519c",size=1,fill='white')+
#   geom_jitter(data=subset(GSVA_targetedcombined,log2_CT>log2(50)),aes(x=log2(50),y=IFN_gamma),width =0.1,color="#2ca25f",size=2.5,alpha=0.5)+scale_x_reverse()+theme(plot.title = element_text(size = 15),
#         legend.position = "none",
#         axis.text = element_text(size = 15),
#         axis.text.x=element_text(color="black",size=13,face="bold"),
#         axis.title.x = element_text(size = 15,color="black",face="bold"),
...
#         legend.key = element_rect(colour = NA),
#         strip.text=element_text(face = "bold",size=12))+ylab("Enrichment score of IFN gamma signaling pathways")+xlab("Mtb Xpert Ct value")
GSVA_targetedcombined %<>% mutate(Status=ifelse(Study=="43TB","Heathly control","PTB")) 
p1.2<-ggplot(GSVA_targetedcombined, aes(x = Status, y = IFN_gamma)) +
  geom_boxplot(size=1,position=position_dodge(1),width=0.7,
               fill="white",outlier.colour="red", 
               outlier.shape=NA,outlier.size=3)+
  geom_jitter(aes(fill=Status,colour=Status),width=0.2, height=0,size=2,alpha = 0.5)+
  scale_color_manual(values=c("#00441b","#313695"))+
  theme_bw()+
  labs(x="Disease",y = "Enrichment score of IFN gamma signaling pathways")+
  theme(plot.title = element_text(size = 15),
        legend.position = "none",
        axis.text = element_text(size = 15),
        axis.text.x=element_text(color="black",size=13,face="bold"),
        ...
        legend.key = element_rect(colour = NA),
        strip.text=element_text(face = "bold",size=12))+
  stat_compare_means(aes(label = paste0("p = ", ..p.format..)), size = 4,label.x = 1.5, label.y = 2.3)+scale_x_discrete("",labels = c("Healthy" = "Healthy",
                                   "PTB" = "PTB"))
...
```{r}
png(file=paste0(path_output_2,"/Figure_3A_Asociation_between_Mtb_burden_IFN_gamma.png"), wi = 12, he = 10,units = 'in', res = 480)
cowplot::plot_grid(p1.2,p1,p2,p3,p4,p5, nrow = 2)
dev.off()
```
