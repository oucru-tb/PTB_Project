...
l<-load("C:/Users/triettm/OneDrive - Oxford University Clinical Research Unit/#OUCRU-TB/#oucru-tb/PTB_project/Raw_data/vst_Gensymbol_allPTB_295Sample_18Feb22.RData")
clinical <- vst_data %>% 
...
In this analysis, we aim to find the connection between CNIH4 with the gene network of T-cell receptor signaling pathways. - We select all the genes forms this network, and perform the Random-forest network. This is a ML method.
