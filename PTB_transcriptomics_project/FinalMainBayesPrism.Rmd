...
gc()
diff.exp.stat <- get.exp.stat(sc.dat=sc.dat[,colSums(sc.dat>0)>5],
                              cell.type.labels=celltypes,
...
#tbm.theta <- ptb.theta
#tbm.z <- ptb.z
#save(tbm.theta,tbm.z,file=paste0(path_output,"/deconvolution/bp.res_tbm2_PBMC_01_01.RData"))

#save(ptb.theta, ptb.z, file = "results/bp.res_healthy_PBMC_01_01.RData")
